...
<head>
  ...
  <title>About the Writers | Instituto Hack</title>
...
<body class="font-serif bg-gray-50">
  ...
  <?php $basePath = '../'; include __DIR__ . '/../partials/navbar.php'; ?>
    ...
    <div class="text-center px-4" data-aos="fade-up">
      <h1 class="py-16 text-4xl md:text-6xl font-bold mb-4">Meet the Authors</h1>
      <p class="text-lg md:text-xl opacity-90">Explore Their Journey</p>
    </div>

  <main class="py-20 bg-white">
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="space-y-12">
        <section class="rounded-2xl bg-[#f5efe6] shadow-md overflow-hidden" data-aos="fade-right">
          <div class="flex flex-col md:flex-row items-stretch">
            <div class="md:w-5/12">
              <img src="http://static.photos/workspace/700x900/21" alt="Retrato de Osvaldo Hack" class="w-full h-64 md:h-full object-cover">
            </div>
            <div class="md:w-7/12 p-8 md:p-12">
              <p class="text-amber-700 font-semibold tracking-wide uppercase text-sm">Pastor e Escritor</p>
              <h2 class="text-3xl font-bold text-gray-900 mt-2">Osvaldo Hack</h2>
        ...
        <section class="rounded-2xl bg-gray-100 shadow-md overflow-hidden" data-aos="fade-left">
          <div class="flex flex-col md:flex-row-reverse items-stretch">
            <div class="md:w-5/12">
              <img src="http://static.photos/workspace/700x900/22" alt="Retrato de Jonathan Hack" class="w-full h-64 md:h-full object-cover">
            </div>
            <div class="md:w-7/12 p-8 md:p-12">
              <p class="text-amber-700 font-semibold tracking-wide uppercase text-sm">Pastor e Escritor </p>
              <h2 class="text-3xl font-bold text-gray-900 mt-2">Jonathan Hack</h2>
              <p class="text-gray-700 mt-5 leading-relaxed">
